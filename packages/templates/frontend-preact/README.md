# frontend-preact template

Preact + Vite frontend template for the teehex backend API.

## Purpose

Provides a minimal Preact UI for Todo list/add/toggle and a browser Worker heavy-task demo.
